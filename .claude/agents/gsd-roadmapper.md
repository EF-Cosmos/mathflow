...
Reference full template: `E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/templates/state.md`.
