...
<!-- For checkpoint task examples and patterns, see @E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/references/checkpoints.md -->
...
See `E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
