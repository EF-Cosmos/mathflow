...
- Usage: Reference from command with `@E:/project/laptop/classroom/linux-homework/mathflow/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/project/laptop/classroom/linux-homework/mathflow/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/project/laptop/classroom/linux-homework/mathflow/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
