...
- **Global scope**: `E:/project/laptop/classroom/linux-homework/mathflow/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/project/laptop/classroom/linux-homework/mathflow/.claude/notes/`)
...
2. Glob `E:/project/laptop/classroom/linux-homework/mathflow/.claude/notes/*.md` (if directory exists) — global notes
...
Global (E:/project/laptop/classroom/linux-homework/mathflow/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/project/laptop/classroom/linux-homework/mathflow/.claude/notes/` — works in any directory
